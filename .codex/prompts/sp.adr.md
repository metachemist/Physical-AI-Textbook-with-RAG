...
- "Frontend Stack" (Docusaurus + Tailwind + GitHub Pages as integrated solution)
- "Authentication Approach" (JWT strategy + Auth0 + session handling)
- "Data Architecture" (PostgreSQL + Redis caching + migration strategy)

**❌ BAD (Over-granular):**

- Separate ADRs for Docusaurus, Tailwind, and GitHub Pages
...
- Example: Docusaurus + Tailwind + GitHub Pages = 1 ADR (integrated, change together)
...
1. Generate concise title reflecting the cluster (e.g., "Frontend Technology Stack" not "Use Docusaurus")
...
5. Fill ALL placeholders:
   ...
   - `{{DECISION}}` = list ALL components of cluster (e.g., "Framework: Docusaurus 14, Styling: Tailwind CSS v3, Deployment: GitHub Pages")
